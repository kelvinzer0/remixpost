        ...
        <div class="max-w-3xl mx-auto">
            <div class="bg-blue-50 border border-blue-200 rounded-md p-4 mb-6">
                <p class="text-sm text-blue-800">
                    <strong>{{ organization.name }}</strong> — {{ channels.length }} channel(s) available.
                    Pilih channel yang ingin di-connect.
                </p>
                <p class="text-xs text-blue-600 mt-1">
                    💡 Pinterest board, Instagram mode (post/reel/story), Pin Title, dan Destination Link
                    bisa dipilih per-post saat membuat postingan — tidak perlu ditentukan saat connect.
                </p>
            </div>
